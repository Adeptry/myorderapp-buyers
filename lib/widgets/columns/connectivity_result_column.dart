...
class ConnectivityResultNoneColumn extends ConsumerWidget {
  const ConnectivityResultNoneColumn({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Column(
      ...
      children: [
        ...
        Text(
          context.l10n.connectivityResultNoneColumnTitle,
          style: context.headerTextStyle,
        ),
        const SizedBox(height: WidgetConstants.extraSmallPaddingDouble),
        Text(
          context.l10n.connectivityResultNoneColumnSubtitle,
